...
export const translations: Record<LanguageCode, Translation> = {
    ...
    'zh-CN': {
        settings: {
            ...
            showFolderForDuplicateNames: '重名文件显示文件夹',
            animateJumpScroll: '跳转时使用滚动动画',
            animateCursor: '光标移动时使用动画',
    ...
    ja: {
        settings: {
            ...
            closeWindowWithLastTab: '最後のタブを閉じたらウィンドウも閉じる',
            newFileDefaultMode: '新しいファイルをエディタで開く',
            showRecentFiles: '最近のファイルを表示',
            showFolderForDuplicateNames: '同名ファイルにフォルダーを表示',
            animateJumpScroll: 'ジャンプ時にスクロールをアニメーション',
            animateCursor: 'カーソルの移動をアニメーション',
    ...
    'zh-TW': {
        settings: {
            ...
            showFolderForDuplicateNames: '重名檔案顯示資料夾',
            animateJumpScroll: '跳轉時使用捲動動畫',
            animateCursor: '游標移動時使用動畫',
    ...
    ko: {
        settings: {
            ...
            closeWindowWithLastTab: '마지막 탭을 닫으면 창 닫기',
            newFileDefaultMode: '새 파일을 편집기에서 열기',
            showRecentFiles: '최근 파일 표시',
            showFolderForDuplicateNames: '이름이 같은 파일에 폴더 표시',
            animateJumpScroll: '이동할 때 스크롤 애니메이션',
            animateCursor: '커서 이동 애니메이션',
    ...
    ru: {
        settings: {
            ...
            closeWindowWithLastTab: 'Закрывать окно вместе с последней вкладкой',
            newFileDefaultMode: 'Новый файл открывается в редакторе',
            showRecentFiles: 'Показывать недавние файлы',
            showFolderForDuplicateNames: 'Показывать папку для одинаковых имён',
            animateJumpScroll: 'Анимировать прокрутку при переходе',
            animateCursor: 'Анимировать движение курсора',
    ...
    es: {
        settings: {
            ...
            closeWindowWithLastTab: 'Cerrar la ventana con la última pestaña',
            newFileDefaultMode: 'Nuevo archivo se abre en el editor',
            showRecentFiles: 'Mostrar archivos recientes',
            showFolderForDuplicateNames: 'Mostrar carpeta en nombres duplicados',
            animateJumpScroll: 'Animar el desplazamiento al saltar',
            animateCursor: 'Animar el movimiento del cursor',
    ...
    fr: {
        settings: {
            ...
            closeWindowWithLastTab: 'Fermer la fenêtre avec le dernier onglet',
            newFileDefaultMode: 'Nouveau fichier s\'ouvre dans l\'éditeur',
            showRecentFiles: 'Afficher les fichiers récents',
            showFolderForDuplicateNames: 'Afficher le dossier pour les noms identiques',
            animateJumpScroll: 'Animer le défilement lors d’un saut',
            animateCursor: 'Animer le déplacement du curseur',
    ...
    de: {
        settings: {
            ...
            closeWindowWithLastTab: 'Fenster mit dem letzten Tab schließen',
            newFileDefaultMode: 'Neue Datei im Editor öffnen',
            showRecentFiles: 'Zuletzt geöffnete Dateien anzeigen',
            showFolderForDuplicateNames: 'Ordner bei gleichen Dateinamen anzeigen',
            animateJumpScroll: 'Bildlauf beim Springen animieren',
            animateCursor: 'Cursorbewegung animieren',
    ...
    'pt-BR': {
        settings: {
            ...
            closeWindowWithLastTab: 'Fechar a janela com a última aba',
            newFileDefaultMode: 'Novo arquivo abre no editor',
            showRecentFiles: 'Mostrar arquivos recentes',
            showFolderForDuplicateNames: 'Mostrar pasta para nomes duplicados',
            animateJumpScroll: 'Animar a rolagem ao saltar',
            animateCursor: 'Animar o movimento do cursor',
    ...
    it: {
        settings: {
            ...
            closeWindowWithLastTab: 'Chiudi la finestra con l\'ultima scheda',
            newFileDefaultMode: 'Nuovo file apre nell\'editor',
            showRecentFiles: 'Mostra file recenti',
            showFolderForDuplicateNames: 'Mostra la cartella per nomi duplicati',
            animateJumpScroll: 'Anima lo scorrimento durante i salti',
            animateCursor: 'Anima il movimento del cursore',
    ...
    pl: {
        settings: {
            ...
            closeWindowWithLastTab: 'Zamknij okno razem z ostatnią kartą',
            newFileDefaultMode: 'Nowy plik otwiera się w edytorze',
            showRecentFiles: 'Pokaż ostatnie pliki',
            showFolderForDuplicateNames: 'Pokaż folder przy powtarzających się nazwach',
            animateJumpScroll: 'Animuj przewijanie przy skoku',
            animateCursor: 'Animuj ruch kursora',
    ...
    nl: {
        settings: {
            ...
            closeWindowWithLastTab: 'Venster sluiten met het laatste tabblad',
            newFileDefaultMode: 'Nieuw bestand opent in editor',
            showRecentFiles: 'Toon recente bestanden',
            showFolderForDuplicateNames: 'Map tonen bij dubbele namen',
            animateJumpScroll: 'Scrollen animeren bij springen',
            animateCursor: 'Cursorbeweging animeren',
    ...
    sv: {
        settings: {
            ...
            closeWindowWithLastTab: 'Stäng fönstret med sista fliken',
            newFileDefaultMode: 'Ny fil öppnas i redigeraren',
            showRecentFiles: 'Visa senaste filer',
            showFolderForDuplicateNames: 'Visa mapp vid dubbletter av namn',
            animateJumpScroll: 'Animera rullning vid hopp',
            animateCursor: 'Animera markörens rörelse',
    ...
    vi: {
        settings: {
            ...
            closeWindowWithLastTab: 'Đóng cửa sổ khi đóng thẻ cuối cùng',
            newFileDefaultMode: 'Tệp mới mở trong trình chỉnh sửa',
            showRecentFiles: 'Hiển thị tệp gần đây',
            showFolderForDuplicateNames: 'Hiện thư mục khi trùng tên',
            animateJumpScroll: 'Hoạt ảnh cuộn khi nhảy',
            animateCursor: 'Hoạt ảnh khi con trỏ di chuyển',
    ...
    pt: {
        settings: {
            ...
            restoreStateOnReopen: 'Restaurar estado ao reabrir',
            closeWindowWithLastTab: 'Fechar a janela com o último separador',
    ...
    ro: {
        settings: {
            ...
            closeWindowWithLastTab: 'Închide fereastra odată cu ultima filă',
            newFileDefaultMode: 'Fișier nou se deschide în editor',
            showRecentFiles: 'Afișare fișiere recente',
            showFolderForDuplicateNames: 'Afișează folderul pentru nume duplicate',
            animateJumpScroll: 'Animare la derulare când sari',
            animateCursor: 'Animare la mișcarea cursorului',
    ...
    hu: {
        settings: {
            ...
            closeWindowWithLastTab: 'Ablak bezárása az utolsó lappal',
            newFileDefaultMode: 'Új fájl megnyílik a szerkesztőben',
            showRecentFiles: 'Legutóbbi fájlok megjelenítése',
            showFolderForDuplicateNames: 'Mappa megjelenítése azonos neveknél',
            animateJumpScroll: 'Görgetés animálása ugráskor',
            animateCursor: 'Kurzormozgás animálása',
    ...
    cs: {
        settings: {
            ...
            closeWindowWithLastTab: 'Zavřít okno s poslední kartou',
            newFileDefaultMode: 'Nový soubor se otevře v editoru',
            showRecentFiles: 'Zobrazit nedávné soubory',
            showFolderForDuplicateNames: 'Zobrazit složku u stejných názvů',
            animateJumpScroll: 'Animovat posun při skoku',
            animateCursor: 'Animovat pohyb kurzoru',
    ...
    sk: {
        settings: {
            ...
            closeWindowWithLastTab: 'Zatvoriť okno s poslednou kartou',
            newFileDefaultMode: 'Nový súbor sa otvorí v editore',
            showRecentFiles: 'Zobraziť nedávne súbory',
            showFolderForDuplicateNames: 'Zobraziť priečinok pri rovnakých názvoch',
            animateJumpScroll: 'Animovať posun pri skoku',
            animateCursor: 'Animovať pohyb kurzora',
    ...
    el: {
        settings: {
            ...
            closeWindowWithLastTab: 'Κλείσιμο παραθύρου με την τελευταία καρτέλα',
            newFileDefaultMode: 'Νέο αρχείο ανοίγει στον επεξεργαστή',
            showRecentFiles: 'Εμφάνιση πρόσφατων αρχείων',
            showFolderForDuplicateNames: 'Εμφάνιση φακέλου για διπλότυπα ονόματα',
            animateJumpScroll: 'Κινούμενη κύλιση κατά τη μετάβαση',
            animateCursor: 'Κινούμενη μετακίνηση δρομέα',
        ...
        settings: {
            ...
            closeWindowWithLastTab: 'Sulje ikkuna viimeisen välilehden mukana',
            newFileDefaultMode: 'Uusi tiedosto avautuu editorissa',
            showRecentFiles: 'Näytä viimeisimmät tiedostot',
            showFolderForDuplicateNames: 'Näytä kansio samannimisille tiedostoille',
            animateJumpScroll: 'Animoi vieritys hypättäessä',
            animateCursor: 'Animoi kohdistimen liike',
    ...
    da: {
        settings: {
            ...
            closeWindowWithLastTab: 'Luk vinduet med den sidste fane',
            newFileDefaultMode: 'Ny fil åpnes i redigeringsprogram',
            showRecentFiles: 'Vis seneste filer',
            showFolderForDuplicateNames: 'Vis mappe ved ens filnavne',
            animateJumpScroll: 'Animer rulning ved spring',
            animateCursor: 'Animer markørbevægelse',
    ...
    no: {
        settings: {
            ...
            closeWindowWithLastTab: 'Lukk vinduet med den siste fanen',
            newFileDefaultMode: 'Ny fil åbnes i editor',
            showRecentFiles: 'Vis nylige filer',
            showFolderForDuplicateNames: 'Vis mappe ved like filnavn',
            animateJumpScroll: 'Animer rulling ved hopp',
            animateCursor: 'Animer markørbevegelse',
    ...
    id: {
        settings: {
            ...
            closeWindowWithLastTab: 'Tutup Jendela bersama Tab Terakhir',
            newFileDefaultMode: 'File baru terbuka di editor',
            showRecentFiles: 'Tampilkan File Terbaru',
            showFolderForDuplicateNames: 'Tampilkan Folder untuk Nama Ganda',
            animateJumpScroll: 'Animasikan Gulir saat Melompat',
            animateCursor: 'Animasikan Gerakan Kursor',
    ...
    tr: {
        settings: {
            ...
            closeWindowWithLastTab: 'Son sekmeyle birlikte pencereyi kapat',
            newFileDefaultMode: 'Yeni dosya editörde açılır',
            showRecentFiles: 'Son Dosyaları Göster',
            showFolderForDuplicateNames: 'Aynı adlı dosyalarda klasörü göster',
            animateJumpScroll: 'Atlarken kaydırmayı canlandır',
            animateCursor: 'İmleç hareketini canlandır',
